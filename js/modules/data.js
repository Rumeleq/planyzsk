...
export const ofilenames = Object.values(o_json) + '.html';
export const sspanTexts = Object.keys(s_json).map(key => /^\d{2}$/.test(key) ? 's' + key : key);
export const sfilenames = Object.values(s_json) + '.html';
export const nspanTexts = `${initials_name_dict[Object.keys(n_json)]} (${Object.keys(n_json)})`;
export const nfilenames = Object.values(n_json) + '.html';

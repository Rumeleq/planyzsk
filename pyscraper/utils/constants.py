...
with open(f'{JSON_PATH}n_map.json', 'r', encoding='utf-8') as f:
    N_MAP: dict[str, str] = json.load(f)
with open(f'{JSON_PATH}o_map.json', 'r', encoding='utf-8') as f:
    O_MAP: dict[str, str] = json.load(f)
with open(f'{JSON_PATH}s_map.json', 'r', encoding='utf-8') as f:
